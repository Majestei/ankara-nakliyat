                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div className="mt-8 md:mt-16 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                                    ...
                                    <a href={`tel:${phone.replace(/\s/g, "")}`} className="w-full sm:w-auto px-6 md:px-10 py-4 md:py-5 bg-white/5 border border-white/10 backdrop-blur-xl text-white rounded-2xl md:rounded-full text-sm md:text-lg font-black hover:bg-white/10 transition-all flex items-center justify-center gap-3 md:gap-4">
